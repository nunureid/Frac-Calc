   ...
   public static String produceAnswer(String line) {
     //Tokenize the input into left, opertor and right parts
      ...
      public static String add(){
         ...
         A = S1*(A2*B1) + S2*(A1*B2);
         B = B1*B2;
         System.out.println("Before gcd: A: "+ A);
         System.out.println("Before gcd: B: "+ B);
      ...
      public static String subtract() {
         ...
         System.out.println("Subtract: B = " + B);
      ...
      public static String multiply() {
         ...
         System.out.println("Multiply:B = " + B);
